...
from app.services.evidence.summarizer import build_assumptions_from_evidence, summarize_evidence
...
def ingest_youtube_evidence(run_id: UUID) -> AnalysisRun:
    ...
    try:
        ...
        assumptions = build_assumptions_from_evidence(run.channel_niche, evidence_summary)
